                ...
                $(window).resize(resizeCanvas);
                    ...
                    for(var j=0;j<positions.length;j++)
                    {
                        ...
                        var deg = angles[j] * (180/pi);
                          ...
                          bar.angle = deg;
//                        bar.animate('angle', deg ,{   // tato funkcia mi nefungovala nezistil som preco, skusal som to vseliako 
//                            duration:4000,
//                            onChange: canvas.renderAll.bind(canvas)});
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse mr-3" id="navbarNav">
                ...
                <div class="row col-12 ml-4">
                    <a class="nav-link offset-4 btn btn-dark col-xs-2" href="kyvadlo.php"><i id="slovakiaIcon"></i></a>
                    <a class="nav-link active btn btn-dark col-xs-2" href="kyvadloEN.php"><i id="ukIcon"></i></a>
                </div>
...
<div class="container">
    <div class="jumbotron">
        ...
        <h1 class="display-5">Inverted Pendulum</h1>
        <hr>
        <form action="kyvadloEN.php" method="get">
            <div class="form-group form-row">
                <div class="col-md-4">
                    <label for="prikaz"><h3>Insert value R in interval <0,1></h3></label>
