...
//              }
                ...
                $(document).ready(function() {
                    var  trace1 = {
                        ...
                        y: [],
                        type: 'scatter',
                        name: 'Actual position of a ball',
                        line: {
                            shape: 'spline',
                            smoothing: 1.3,
...
<div class="container">
    <div class="jumbotron">
        ...
        <h1 class="display-5">Ball on the bar</h1>
        <hr>
        <form action="gulickaEN.php" method="get">
            <div class="form-group form-row">
                <div class="col-md-4">
                    <label for="prikaz"><h3>Insert command</h3></label>
                    <input type="text" class="form-control form-control-lg" name="R" id="R" placeholder="R">
                    <small id="emailHelp" class="form-text text-muted">Insert R</small>
                </div>
        ...
        <label for="graphDiv" id="graphLabel"><h3>Output</h3></label>
        <br>
